...
const page = () => {
    ...
    const { courseDetails: { programInfo: { calendarEvents } } } = allDetails || { courseDetails: { programInfo: { calendarEvents: '' } } };

    return (
        <section className='min-h-screen card2'>
            <h3 className='heading1'>Calendar of Events</h3>
            <Link href={calendarEvents} target='_blank' className='relative w-16 h-16 hover:cursor-pointer block mb-6'>
