...
const page = () => {
    ...
    const { courseDetails: { programInfo: { faqs } } } = allDetails || { courseDetails: { programInfo: { faqs: '' } } };

    return (
        <section className='min-h-screen card2'>
            <h3 className='heading1'>FAQs</h3>
            <Link href={faqs} target='_blank' className='relative w-16 h-16 hover:cursor-pointer block mb-6'>
