...
const Sidebar = () => {
    ...
    return (
        <ul className='min-h-screen bg1 max-[860px]:hidden sidebar' id='myID'>
            ...
            <li className='cursor-pointer text-gray-600 hover:bg-zinc-200 border-b'><Link href={'/teachers'} className='block'><span className='p-4 flex-col text-sm tracking-normal flex items-center'><RiDiscussFill className='mb-1' size={18} /><span className='text-xs'>Forums</span></span></Link></li>
            <li className='cursor-pointer text-gray-600 hover:bg-zinc-200 border-b'><Link href={'/teachers'} className='block'><span className='p-4 flex-col text-sm tracking-normal flex items-center'><ImBooks className='mb-1' size={18} /><span className='text-xs'>Assessments</span></span></Link></li>
        </ul>
    )
}
