...
const Sidebar = () => {
    ...
    return (
        <ul className='min-h-screen bg1 max-[860px]:hidden sidebar' id='myID'>
            ...
            <li className='cursor-pointer text-gray-600 hover:bg-zinc-200 border-b'><Link href={'/users'} className='block'><span className='p-4 flex-col text-sm tracking-normal flex items-center'><FaUserAlt className='mb-1' size={18} /><span className='text-xs'>Students</span></span></Link></li>
            <li className='cursor-pointer text-gray-600 hover:bg-zinc-200 border-b'><Link href={'/teachers'} className='block'><span className='p-4 flex-col text-sm tracking-normal flex items-center'><FaUserAlt className='mb-1' size={18} /><span className='text-xs'>Teachers</span></span></Link></li>
        </ul>
    )
}
